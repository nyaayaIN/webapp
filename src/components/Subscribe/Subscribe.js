      ...
      <div className={s.root}>
        <div className={s.container}>
          ...
          <form className={s.form}
                ...
                method="post"
                data-id="">
            <input className={s.input} placeholder={this.state.i18n.email} name="cm-fjrjil-fjrjil" type="email" required />
            <button className={s.button} type="submit">{this.state.i18n.action}</button>
          </form>
        </div>
      </div>
    );
